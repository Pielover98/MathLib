...
void drawPlane(const Plane & P, unsigned int color)
{
	...
	sfw::drawLine(P.pos.x, P.pos.y, P.pos.x + left.x * 120, P.pos.y + left.y * 120, color);
	sfw::drawLine(P.pos.x, P.pos.y, P.pos.x + right.x * 120, P.pos.y + right.y * 120, color);
}